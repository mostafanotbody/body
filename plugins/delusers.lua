...
if matches[1] == 'clean deleted' or 'تنظيف حسابات المحذوفة' and is_mod(msg) and msg.to.type == "channel" then 
...
tdcli.getUser(v.user_id_, clean_cb, nil)
    ...
    tdcli.sendMessage(msg.to.id, msg.id, 1, '_✅ تم مسح جميع الحسابات المحذوفة من المجموعة 🗑_', 1, 'md') 
  end 
